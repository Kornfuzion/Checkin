...
public class GetYourPlaces  extends AsyncTask<String,Void,String>{
   ...
   protected void onPreExecute(){
	   super.onPreExecute();
	   preferences = context.getSharedPreferences("sol", 0);
	   broadcast=preferences.getBoolean("getData",false);
	   refreshed=preferences.getBoolean("refreshed",false);
	   Log.d("g","getdata preexecute");
